...
En parallèle de ma licence, je me forme de façon autonome à la cybersécurité : laboratoires TryHackMe et VulnHub, CTF d’initiation et tests d’intrusion sur des machines virtuelles.

**Environnements**  
- Virtualisation : QEMU/KVM, VirtualBox · Conteneurisation Docker  
...
**Exploitation**  
- Frameworks : Metasploit, Burp Suite, OWASP ZAP  
- Outils : Hydra, John the Ripper, sqlmap  
- Techniques : élévation de privilèges Linux, injections SQL, upload de web-shells, reverse shells, cracking de hachages.  
